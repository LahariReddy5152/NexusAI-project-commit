...
(() => {
    ...
    const INTERVIEW_BANK = {
        Python: {
            fundamentals: ["Explain list vs tuple and when to use each.", "What are decorators and how do they work?"],
            system: ["Design a caching layer for an API using Python.", "How would you structure a FastAPI microservice?"],
            behavioral: ["Describe debugging a production Python issue.", "How do you ensure code quality in Python projects?"]
        },
        Java: {
    ...
    function renderCareerModeInsights() {
        ...
        const gaps = career?.skillGaps || ["System design depth", "Portfolio metrics"];
        const recommendations = ["Use Career Roadmap tab for role-specific milestones", "Quantify project outcomes on resume", "Align ATS keywords to target role"];
        ...
        panel.innerHTML = `
            ...
            <p><strong>Next step:</strong> Open <em>Career Roadmap</em> and pick an independent path (AI Engineer, Java Full Stack, Cloud, etc.).</p>
        `;
    }
